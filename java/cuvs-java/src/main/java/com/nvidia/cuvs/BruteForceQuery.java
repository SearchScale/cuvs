...
public class BruteForceQuery {
  ...
  /**
   * Constructs an instance of {@link BruteForceQuery} using cagraSearchParameters,
   ...
   */
  public BruteForceQuery(CagraSearchParams cagraSearchParameters, float[][] queryVectors, Map<Integer, Integer> mapping,
      int topK) {
    super();
  ...
  public static class Builder {
    ...
    public BruteForceQuery build() {
      return new BruteForceQuery(cagraSearchParams, queryVectors, mapping, topK);
    }
  }
}
