...
public class cuvsCagraCompressionParams {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cagra_h.C_INT.withName("pq_bits"),
        cagra_h.C_INT.withName("pq_dim"),
        cagra_h.C_INT.withName("vq_n_centers"),
        cagra_h.C_INT.withName("kmeans_n_iters"),
        cagra_h.C_DOUBLE.withName("vq_kmeans_trainset_fraction"),
        cagra_h.C_DOUBLE.withName("pq_kmeans_trainset_fraction")
    ...
    private static final OfDouble vq_kmeans_trainset_fraction$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("vq_kmeans_trainset_fraction"));
    ...
    private static final OfDouble pq_kmeans_trainset_fraction$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("pq_kmeans_trainset_fraction"));
